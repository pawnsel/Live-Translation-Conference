    ...
    <div className="space-y-4">
        ...
        {sharing ? (
          ...
          <>
            ...
            <p className="text-[11px] text-slate-500 leading-relaxed">
              เลือก <b>หน้าต่าง PowerPoint</b> บนจอโน้ตบุ๊ค — picker จะมีให้เลือกแต่หน้าต่างกับแท็บ
              เพราะการแชร์ทั้งจอที่สองคือการแชร์หน้าต่าง Output ที่ฉายอยู่บนจอนั้นเอง ภาพจะซ้อนกันไม่รู้จบ
            </p>
          </>
        )}
      ...
      <details className="bg-white rounded-xl border border-slate-200 p-3.5 text-[11px] text-slate-600 leading-relaxed">
        ...
        <ol className="list-decimal pl-4 mt-2 space-y-1.5">
          ...
          <li>แถบ <b>"กำลังแชร์หน้าจอ"</b> ของ Chrome ซ่อนทั้งแถบไม่ได้ (เป็น UI ของเบราว์เซอร์ ไม่ใช่ของเว็บนี้)
            แต่กดปุ่ม <b>ซ่อน</b> ให้ยุบเป็นปุ่มเล็กได้ และแถบนี้ <b>ไม่ติดไปในภาพบนจอที่สอง</b>
            เพราะเราแชร์เฉพาะหน้าต่างสไลด์ ไม่ใช่ทั้งจอ</li>
