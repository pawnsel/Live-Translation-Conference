...
คำเหล่านี้ถูกส่งไปเป็น `customVocabulary` ตอนเปิด session เพื่อ**ช่วยให้ระบบ
รู้จำเสียงคำเหล่านั้นแม่นขึ้น** โดยใช้เฉพาะฝั่งภาษาต้นทาง (ตัวรู้จำเสียงฟัง
ภาษาต้นทาง ไม่ได้ฟังคำแปล) — สำหรับหมวดแก้คำผิดจะใช้ "คำที่ถูก" ไม่ใช่คำที่
ฟังผิด เนื่องจากตั้งค่าได้เฉพาะตอนเปิด session การแก้ glossary ระหว่าง
session จะมีผลกับ session ถัดไป
