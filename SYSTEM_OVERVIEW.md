...
3. **Stage 1920×1080** (`src/stream/OutputStage.tsx`) — สไลด์ + แถบคำแปล
   ...
   ป้าย latency และข้อความ "กำลังแปล…" ปรับความกว้างแถบและล็อกตำแหน่งได้จากแท็บ
   สตรีม ค่าเก็บต่อเครื่อง (`src/storage/outputStore.ts`) มีสองรูปแบบการวาง:
   - **ทับบนสไลด์** (ค่าเริ่มต้น) — สไลด์เต็มพื้นที่ คำแปลซ้อนอยู่ด้านบน ลากย้าย
     ตำแหน่งได้ในหน้าต่าง Output
