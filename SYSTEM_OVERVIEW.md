...
ทั้งสองแบบดึงจากรายการ caption ที่มองเห็นอยู่ (ไม่รวมรายการที่ถูกซ่อน) รวมคำแปล
ที่ operator แก้ไขเองด้วย ส่วนสรุปด้วย AI และบันทึกโปรเจกต์ถาวรจะรวมรายการที่
ถูกซ่อนไว้ด้วยเสมอ (ไม่มีข้อมูลสูญหาย)
